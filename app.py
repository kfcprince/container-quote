...
default_data = [
    ...
    ['露台', '项', 0, 4500, 4500, 4500, 4500, 4500, 4500],
    ['露台顶', '项', 0, 3500, 3500, 3500, 3500, 3500, 3500],
...
with c3:
    ...
    if roof_100_cn != '无' and not is_x:
        bill.append({"Cat": t_cat("装修"), "Item": "100厚顶板", "Spec": roof_100, "Qty": 1, "RMB": get_p(roof_100_cn, size)})
